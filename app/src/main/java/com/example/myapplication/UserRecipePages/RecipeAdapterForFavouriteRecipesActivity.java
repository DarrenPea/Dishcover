...
public class RecipeAdapterForFavouriteRecipesActivity extends RecyclerView.Adapter<RecipeAdapterForFavouriteRecipesActivity.RecipeViewHolder> {
    ...
    public RecipeAdapterForFavouriteRecipesActivity(Context context, List<Recipe> recipeList, UserRecipeOnClickListener listener) {
