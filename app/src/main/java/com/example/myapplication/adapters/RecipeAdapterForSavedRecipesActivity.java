...
public class RecipeAdapterForSavedRecipesActivity extends RecyclerView.Adapter<RecipeAdapterForSavedRecipesActivity.RecipeViewHolder> {
    ...
    public RecipeAdapterForSavedRecipesActivity(Context context, List<Recipe> recipeList, UserRecipeOnClickListener listener) {
